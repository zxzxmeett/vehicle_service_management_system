                ...
                {vehicles.map((v) => (
                  ...
                  >
                    <div>
                      ...
                      <p className="text-sm text-slate-500 dark:text-[#9fb0c3]">{v.customerName}</p>
                    </div>

                    <button
                      onClick={() => markDone(v._id)}
                      className="h-9 rounded-md bg-slate-900 dark:bg-blue-600 px-4 text-sm font-medium
                             text-white transition hover:bg-slate-800 dark:hover:bg-blue-500 active:scale-[0.99]"
                    >
                      Mark as Completed
                    </button>
                  </div>
