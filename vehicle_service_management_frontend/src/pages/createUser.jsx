                ...
                <table className="w-full text-sm">
                  ...
                  <tbody>
                    {users.map((user) => (
                      ...
                      >
                        <td className="py-2 text-slate-900 dark:text-[#e6eef6]">{user.name}</td>
                        <td className="text-slate-700 dark:text-[#9fb0c3]">{user.email}</td>
                        <td className="text-slate-700 dark:text-[#9fb0c3]">{user.role}</td>
